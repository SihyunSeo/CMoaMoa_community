	...
	<div class="body-box">
		...
		<div>
			...
			<div class="board_btn_box">
				<button onclick="location.href='/CMoaMoa/IO_Campus/InCam.jsp?board_no=121'">교내</button>
				<button class="activate-btn" onclick="location.href='/CMoaMoa/IO_Campus/OutCam.jsp?board_no=122'">교외</button>
			</div>
		</div>
		...
		<button class="write-btn" type=button onclick="location.href='/CMoaMoa/write_board.jsp?board_no=122'">글쓰기</button>
	</div>
