	...
	<div class="body-box">
		...
		<div>
			...
			<div class="board_btn_box">
				<button class="activate-btn" onclick="location.href='/CMoaMoa/Comp_Moa_Board/Competition.jsp?board_no=111'">소식</button>
				<button onclick="location.href='/CMoaMoa/freeBoard/freeboard.jsp?board_no=112&&maxPage=1&&nowPage=1'">팀</button>
			</div>
		</div>
		...
		<button class="write-btn" type=button onclick="location.href='/CMoaMoa/write_board.jsp?board_no=111'">글쓰기</button>
		<!-- ----------------------------------------------------------------------------------------------------------------------- -->
	</div>
